    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="currentPhase === 0" class="badge processing">En cours de génération</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            Le LLM analyse le contenu des documents et les besoins de simulation, extrait les graines de réalité, et génère automatiquement une structure d'ontologie adaptée
          </p>

          <!-- Loading / Progress -->
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            <div class="spinner-sm"></div>
            <span>{{ ontologyProgress.message || 'Analyse des documents en cours...' }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Sur la base de l'ontologie générée, les documents sont automatiquement segmentés puis Zep est appelé pour construire le graphe de connaissances, extraire les entités et les relations, et former une mémoire temporelle et des résumés de communautés
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Types SCHEMA</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          >
            ...
            {{ creatingSimulation ? 'Création en cours...' : 'Accéder à la configuration de l\'environnement ➝' }}
          </button>
        </div>
      </div>
    </div>
...
// Accéder à la configuration de l'environnement - créer la simulation et rediriger
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('Informations du projet ou du graphe manquantes')
    return
  }
